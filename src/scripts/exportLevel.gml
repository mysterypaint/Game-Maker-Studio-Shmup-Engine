...
//Search for a location/file we can export our level to
...
var qu = chr(34); //Macro for inserting a " character, to make the code more bearable to read (and to prevent String input syntax errors)
